var quotes = [
 ...
 'Which animal would you like to be much bigger than it currently is?',
 ...
 'The Scouts motto is 'be prepared'. What\'s your motto?',
 ...
 'An epic feast is held in your honor, what\’s on the table?',
  'Who is the first person on your hit list?',
  'What would you leave me in your will?',
  ...
  'If you could choose one imaginary friend, who would it be?',
  'If you could make a magic potion what would it do?',
  'If you could write a new law what would it be?',
  'Do you know any Chuck Norris 'facts'?',
  ...
  'Is there a God?',
  'Is the universe finite or infinite? If it\'s finite, what\'s it expanding in to. If it\'s infinite, how is that possible? Is it just endlessly the same, like daytime television?',
  'What\'s you favorite film or book quote?',
